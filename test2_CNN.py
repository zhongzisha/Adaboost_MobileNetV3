...
#######function def:
def train_CNN(X_train=None, y_train=None, epochs=None, batch_size=None, X_test=None, y_test=None, n_features=10,
              seed=100):
    ######ranome seed
    numpy.random.seed(seed)
    # set_random_seed(seed)
...
def synethetic_data(n_features=10, n_classes=3):
    ...
    def plot_hist(y_test, oName0):
        ...
        (n, bins, patches) = plt.hist(y_test + 1,
...
train_CNN(X_train=X_train, y_train=y_train, epochs=100,
